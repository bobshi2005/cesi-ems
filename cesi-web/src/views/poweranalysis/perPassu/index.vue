        ...
        <div class="content-area" v-loading="loading">
          ...
          <div class="chart-card">
            <div class="chart-card-head">
              <span>{{ queryParams.nodeName }}-能耗环比分析</span>
              <span class="head-tag">环比</span>
            </div>
          ...
          <div class="chart-card">
            <div class="chart-card-head">
              <span>{{ queryParams.nodeName }}-能耗环比分析表-{{ queryParams.enername }}</span>
            </div>
            <div class="table-box">
...
<script setup name="perPassu">
import { queryLoopCompareList } from "@/api/energyAnalysis/energyAnalysis"
    ...
    setTimeout(() => {
      ...
      echarts.init(dom).setOption({
        ...
        yAxis: [
          ...
          {
            type: "value", name: "环比(%)", alignTicks: true,
            nameTextStyle: { color: textColor, fontSize: 12, padding: [0, 0, 5, 0] },
            axisLine: { show: false }, axisTick: { show: false },
