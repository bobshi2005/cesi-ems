...
import com.cesi.basicdata.domain.vo.EnergyTypeMeterPointVO;
import com.cesi.model.domain.EnergyIndexQuery;
import com.cesi.model.domain.MeterPoint;
import com.cesi.model.domain.vo.MeterPointAddDTO;
import com.cesi.model.domain.vo.MeterPointEditDTO;
...
public interface MeterPointMapper extends BaseMapper<MeterPoint> {
     ...
     * @return 结果
     */
    int insertMeterPoint(MeterPointAddDTO meterPointAddDTO);
